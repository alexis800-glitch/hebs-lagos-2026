            ...
            >
              ...
              <ul className="flex flex-col gap-3 mb-10 flex-1">
                {tier.features.map((feature, i) => (
                  <li
                    key={i}
                    className="flex items-start gap-2.5 font-sans text-xs text-zinc-300 font-light"
                  >
                    <span
              ...
              <a
                ...
                className={`block w-full text-center font-sans text-xs uppercase tracking-widest py-4 rounded-xl font-medium transition-all duration-200 ${
                  tier.featured
