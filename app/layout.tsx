...
export const metadata: Metadata = {
  ...
  description:
    "The Hair Education Beauty Summit returns for Year 3. October 23–25, 2026 at NJS Royale Events Center, Richland Garden Estate, Lekki-Epe Expressway, Lagos. $85,000 USD (₦119,000,000) in prizes.",
  keywords: [
    "HEBS",
